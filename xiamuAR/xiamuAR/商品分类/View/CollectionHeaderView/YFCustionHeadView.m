...
@interface YFCustionHeadView ()

/** 记录上一次选中的Button */
@property (nonatomic , weak) YFCustionButton *selectBtn;
/** 记录上一次选中的Button底部View */
@property (nonatomic , strong)UIView *selectBottomRedView;

@end
@implementation YFCustionHeadView
#pragma mark - Intial
...
- (void)setUpUI
{
    ...
    for (NSInteger i = 0; i < titles.count; i++) {
        YFCustionButton *button = [YFCustionButton buttonWithType:UIButtonTypeCustom];
...
#pragma mark - 按钮点击
- (void)buttonClick:(YFCustionButton *)button
{
