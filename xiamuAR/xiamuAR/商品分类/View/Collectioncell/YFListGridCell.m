...
-(void)layoutSubviews
{
    ...
    [_gridImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        [make.left.mas_equalTo(self)setOffset:YFMargin * 2];
        make.size.mas_equalTo(CGSizeMake(90, 90));
    }];
    
    [_autotrophyImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        [make.left.mas_equalTo(_gridImageView.mas_right)setOffset:YFMargin];
    ...
    [_colonButton mas_makeConstraints:^(MASConstraintMaker *make) {
        [make.right.mas_equalTo(self)setOffset:-YFMargin];
        [make.bottom.mas_equalTo(self)setOffset:-YFMargin];
